...
//                }
            ...
            case R.id.get_width_height:
                ...
                Log.d("yuanhang","the screen size is "+point.toString());
                getWindowManager().getDefaultDisplay().getRealSize(point);
                Log.d("yuanhang","the screen real size is "+point.toString());
            break;
            ...
            case R.id.rotate_90:
                ...
                Utils.getValueFromProp("persist.sys.displayrot");
                break;
            case R.id.rotate_0:
                manager.rotateScreen(this,"0");
                break;
            case R.id.update_img:
                manager.upgradeSystem(Environment.getExternalStorageDirectory().getPath() +"/update.zip"); ///mnt/media_rw/10C0-C930/update.zip  Environment.getExternalStorageDirectory().getPath() + "/Download/update.zip"
                Log.d("chenhuan","externalStoragePath = " +Environment.getExternalStorageDirectory().getPath() +"/update.zip");
...
//                    Toast.makeText(getApplicationContext(), "外置U盘路径 = " + USBPath, Toast.LENGTH_SHORT).show();
            ...
            case R.id.set_dormant_interval:
                ...
                Utils.getValueFromProp("persist.ys.factroy.code");
                break;
